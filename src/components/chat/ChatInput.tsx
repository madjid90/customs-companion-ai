...
export function ChatInput({
  ...
  return (
    <>
      <div className="border-t border-border bg-card/90 backdrop-blur-xl px-2 pt-2 md:px-4 md:pt-4 md:pb-4 flex-shrink-0" style={{ paddingBottom: 'max(0.75rem, env(safe-area-inset-bottom, 0.75rem))' }}>
